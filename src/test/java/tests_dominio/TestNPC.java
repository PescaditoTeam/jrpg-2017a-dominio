...
public class TestNPC {
    ...
    public void testNPC() {
        int dificultadNPC = 0;
        if (dificultadNPC == 0) {
            NonPlayableCharacter a = new NonPlayableCharacter("C", 23,
                    dificultadNPC);
        ...
        dificultadNPC = 1;
        if (dificultadNPC == 1) {
            NonPlayableCharacter b = new NonPlayableCharacter("A", 23,
                    dificultadNPC);
