...
public class TestAsesino {
    ...
    public void testAsesino() {
        ...
        Assert.assertFalse(a.habilidad3(new Humano("asd", new Hechicero(), 3),
                new Humano("assd", new Hechicero(), 23)));
    ...
    public void testProbEvasion() {
        ...
        Assert.assertEquals(0.45, h.getCasta().getProbabilidadEvitarDaño(),
                0.01);
        h.habilidadCasta2(null);
